...
&emsp;* you will be prompted, one at a time, to enter a task from the keyboard (e.g: homework solving)
&emsp;* you will be asked to enter a deadline for the task (e.g: 22.01.2022 21:30)
&emsp;* add a person responsible for the task (e.g: Ion Vasile)
&emsp;* add a category that the task belongs to. (E.g. course)  
